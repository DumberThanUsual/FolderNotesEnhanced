 ...
 */
var getNoteElement = function(dataPath, node) {
    if (dataPath) {
        ...
        for (var i = 0; i < folderPaths.length; i++) {
          ...
          properties.then(
            function(value) { console.log(value);
              node.appendChild(createNoteElement(dataPathRel, value["notes"], value["color"]));
             },
...
var perform = function(node) {
    ...
    if (dataPath != undefined) {
        var noteElement = getNoteElement(dataPath, node);
    }
